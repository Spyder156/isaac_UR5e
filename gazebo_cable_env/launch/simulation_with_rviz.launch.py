#!/usr/bin/env python3
"""
Launch file for Cable Insertion Simulation with RViz visualization
Includes 3 camera views for perception pipeline
"""
...
def generate_launch_description():
    ...
    # RViz config
    rviz_config = os.path.join(pkg_path, 'config', 'perception.rviz')
    ...
    # Delay RViz to let simulation start first
